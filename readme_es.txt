...
= Soporte técnico =
**Art Project Group** te ofrece [**Soporte técnico**](http://wcprojectgroup.es/tienda/ticket-de-soporte) para configurar o instalar ***WC - APG City***.
...
= Más información =
En nuestro sitio web oficial puede obtener más información sobre [**WC - APG City**](http://artprojectgroup.es/plugins-para-wordpress/plugins-para-woocommerce/wc-apg-city). 

= Comentarios =
No olvides dejarnos tu comentario en:

* [WC - APG City](http://artprojectgroup.es/plugins-para-wordpress/plugins-para-woocommerce/wc-apg-city) en Art Project Group.
...
3. Listo, ahora ya puedes disfrutar de él, y si te gusta y te resulta útil, hacer una [*donación*](http://artprojectgroup.es/tienda/donacion).
...
= Soporte técnico =
Si necesitas ayuda para configurar o instalar **WC - APG City**, **Art Project Group** te ofrece su servicio de [**Soporte técnico**](http://wcprojectgroup.es/tienda/ticket-de-soporte). 
...
== Soporte técnico ==
Dado que **WC - APG City** es totalmente gratuito, **Art Project Group** sólo proporciona el servicio de [**Soporte técnico**](http://wcprojectgroup.es/tienda/ticket-de-soporte) previo pago. En ningún caso **Art Project Group** proporciona ningún tipo de soporte técnico gratuito.

== Donación ==
¿Te ha gustado y te ha resultado útil **WC - APG City** en tu sitio web? Te agradeceríamos una [pequeña donación](http://artprojectgroup.es/tienda/donacion) que nos ayudará a seguir mejorando este plugin y a crear más plugins totalmente gratuitos para toda la comunidad WordPress.
