...
var comprueba_geonames = function( formulario, google = false ) {
	if ( !jQuery( '#' + formulario + '_city' ).is( 'input' ) ) {
		...
		jQuery.getJSON( "https://www.geonames.org/postalCodeLookupJSON?postalcode=" + jQuery( '#' + formulario + '_postcode' ).val() + "&country=" + jQuery( '#' + formulario + '_country' ).val(), function( data ) {
...
var comprueba_google = function( formulario, geonames = false ) {
	if ( !jQuery( '#' + formulario + '_city' ).is( 'input' ) ) {
		jQuery.getJSON( "https://maps.googleapis.com/maps/api/geocode/json?components=country:" + jQuery( '#' + formulario + '_country' ).val() + "|postal_code:" + jQuery( '#' + formulario + '_postcode' ).val() + "&key=" + google_api, function( data ) {
			///Limpia y mete la opción inicial
			jQuery( '#' + formulario + '_city' ).empty();
			jQuery( '#' + formulario + '_city' ).append( 
				jQuery( "<option></option>" ).attr( "value", "" ).text( texto_predeterminado )
