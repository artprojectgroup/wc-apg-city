...
<div class="wrap woocommerce">
  <h2>
    <?php _e( 'APG City Options.', 'apg_city' ); ?>
  </h2>
  <?php 
	settings_errors(); 
	$tab = 1;
  ...
  <p>
    <?php _e( 'Add to WooCommerce an automatic city name generated from postcode.', 'apg_city' ); ?>
  </p>
  ...
  <form method="post" action="options.php">
    ...
    <table class="form-table apg-table">
      <tr valign="top">
        <th scope="row" class="titledesc"> <label for="apg_city_settings[requerido]">
            <?php _e( 'Select a public API', 'apg_city' ); ?>
          </label>
          <span class="woocommerce-help-tip" data-tip="<?php _e( "Select which API would you want to use", 'apg_city' ); ?>"></span> </th>
    ...
    <p class="submit">
      <input class="button-primary" type="submit" value="<?php _e( 'Save Changes', 'apg_city' ); ?>"  name="submit" id="submit" tabindex="<?php echo $tab++; ?>" />
    </p>
  </form>
</div>
